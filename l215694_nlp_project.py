...
# Modified Transformers imports - using specific classes that are compatible
...
try:
    ...
    print("Warning: Could not import bert_score. This functionality will be unavailable.")
