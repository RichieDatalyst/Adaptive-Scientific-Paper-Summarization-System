...
# Try to import torch, with fallback in case of issues
try:
    import torch
    print(f"Successfully imported torch version: {torch.__version__}")
except ImportError:
    print("Warning: Could not import torch. Some functionality may be limited.")

# Modified Transformers imports with alternative options
# Avoiding classes that depend on tokenizers
try:
    ...
    print("Some model functionality may be unavailable")

# Alternative embedding model that doesn't require tokenizers
try:
    from sentence_transformers import SentenceTransformer
    print("Successfully imported sentence_transformers")
    # This can be used instead of bert-score for similarity calculations
...
# We'll use cosine similarity instead of bert-score
from sklearn.metrics.pairwise import cosine_similarity

# For calculating BLEU score
from nltk.translate.bleu_score import sentence_bleu, SmoothingFunction

# For LangChain and RAG - fixed imports to use community packages
try:
    ...
    print(f"Warning: Issue importing LangChain modules: {e}")
...
try:
    ...
    print("Warning: Could not import Gradio. UI components will not work.")

# Optional UI components
try:
    import ipywidgets as widgets
    from IPython.display import display, clear_output, HTML
    print("Successfully imported IPython widgets")
except ImportError:
    print("Warning: IPython widgets not available. Some UI components may not work.")
...
try:
    ...
    print(f"Warning: Some LangChain components could not be imported: {e}")
